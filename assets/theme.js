...
var QuantityInput = class extends HTMLInputElement {
  constructor() {
    ...
    this.setAttribute('data-current-quantity', this.value || '1');
    const parentSelector = this.closest('quantity-selector');
    if (parentSelector) {
      parentSelector.setAttribute('data-current-quantity', this.value || '1');
    }
  }
  disconnectedCallback() {
    this._abortController?.abort();
  ...
  _onValueInput() {
    ...
    this.setAttribute('data-current-quantity', this.quantity);
    
    const parentSelector = this.closest('quantity-selector');
    if (parentSelector) {
      parentSelector.setAttribute('data-current-quantity', this.quantity);
    }
